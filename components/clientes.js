...
document.querySelector(".header-btn").addEventListener("click", abrirModal);
const cliente = [];
...
document
  ...
  .addEventListener("click", abrirModalDeBuscarClientes);

function abrirModalDeBuscarClientes() {
  const modal = document.getElementById("MainModal");
  const modalContent = document.querySelector(".modal-content");
  modalContent.innerHTML = `
