...
import {
  clientes,
  abrirModalDeAdicionarCliente,
  loadCustomers,
  salvarCliente,
} from "../../components/clientes.js";
window.abrirModalDeAdicionarCliente = abrirModalDeAdicionarCliente
window.salvarCliente = salvarCliente
// document
//   .getElementById("add-client-btn")
//   .addEventListener("click", abrirModalDeAdicionarCliente);
document.addEventListener("DOMContentLoaded", function() {
  renderItems(); // Inicializa a renderização de itens ao carregar o DOM
  document.querySelectorAll(".sidebar button").forEach((button) => {
    button.addEventListener("click", function () {
